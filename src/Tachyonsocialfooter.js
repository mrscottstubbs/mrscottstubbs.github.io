...
import './tachyonsocial.css';

export default class Tachyonsocialfooter extends Component {
    render() {
        return (
            // <!-- SVG Icons are from https://simpleicons.org -->
            <footer className="pv4 ph3 tc">
                <a target="_blank" rel="noopener noreferrer"
                    className="link hover-silver near-black dib mh3 tc" href="https://www.linkedin.com/in/scott-stubbs/" title="LinkedIn">
                ...
                <a target="_blank" rel="noopener noreferrer"
                    className="link near-black hover-silver dib mh3 tc" href="https://github.com/mrscottstubbs" title="GitHub">
                ...
                <a rel="noopener noreferrer"
                    className="link hover-silver near-black dib mh3 tc" href="mailto:scott.lau.stubbs@gmail.com" title="Mail">
                    ...
                    <span className="f6 db">Email</span>
                </a>
