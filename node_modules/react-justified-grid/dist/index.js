...
var curateImageList = function (images, width, setting) {
    var gutter = setting.gutter, rows = setting.rows, maxRowHeight = setting.maxRowHeight, showIncompleteRow = setting.showIncompleteRow;
    var rowWidth = width;
    ...
    var _loop_1 = function () {
        ...
        if (!isFulfilled) {
            ...
            return { value: processedImageList };
        }
...
var JustifiedGrid = /** @class */ (function (_super) {
    ...
    JustifiedGrid.prototype.process = function () {
        var _a = this.props, gutter = _a.gutter, images = _a.images, rows = _a.rows, maxRowHeight = _a.maxRowHeight, showIncompleteRow = _a.showIncompleteRow, width = _a.width, style = _a.style;
    ...
    JustifiedGrid.prototype.sync = function () {
        ...
        if (!images.length) {
            this.setState({ images: images, gridHeight: 0 });
            return;
        }
        var lastImage = images[images.length - 1];
        var gridHeight = lastImage.top + lastImage.height;
        this.setState({ images: images, gridHeight: gridHeight });
    };
    JustifiedGrid.prototype.render = function () {
        var _this = this;
        var _a = this.state, images = _a.images, gridHeight = _a.gridHeight;
        var _b = this.props, rows = _b.rows, gutter = _b.gutter, style = _b.style, originalImages = _b.images, showIncompleteRow = _b.showIncompleteRow, maxRowHeight = _b.maxRowHeight, children = _b.children, width = _b.width, otherProps = __rest(_b, ["rows", "gutter", "style", "images", "showIncompleteRow", "maxRowHeight", "children", "width"]);
        var defaultStyle = { position: 'relative', height: gridHeight + "px" };
        if (width)
            defaultStyle.width = width + "px";
        if (lodash_2(children)) {
            return (React.createElement("div", __assign({ ref: function (el) { return (_this.wrapperEl = el); }, style: lodash_6(defaultStyle, style) }, otherProps), children(images)));
        }
        return (React.createElement("div", __assign({ ref: function (el) { return (_this.wrapperEl = el); }, style: lodash_6(defaultStyle, style) }, otherProps), images.map(function (image, i) {
            return (React.createElement("div", { key: i, "data-offset": i, "data-row-offset": image.rowOffset, style: {
                    position: 'absolute',
                    top: image.top,
                    left: image.left
                } },
                React.createElement("img", { src: image.src, width: image.width, height: image.height, alt: image.alt })));
        })));
    };
...
exports.curateImageList = curateImageList;
exports.default = JustifiedGrid;
